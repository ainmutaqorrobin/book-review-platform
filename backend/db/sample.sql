...
SELECT
    ...
    0.60,
    '["legacy code","refactoring","software design"]'::jsonb
FROM
    clean_code
UNION ALL
SELECT
    pragmatic_programmer.id,
    'Charlie',
    'Pragmatic Programmer opened my eyes to practical career advice.',
    5,
    'Practical and timeless advice',
    0.90,
    '["pragmatic programming","career advice","software development"]'::jsonb
FROM
...
SELECT
    ...
    0.80,
    '["refactoring","legacy systems","code quality"]'::jsonb
FROM
    refactoring_book;
